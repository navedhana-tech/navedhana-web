...
// stronger blue wash turns the cream grey and kills the warmth that makes
// the palette work.
const GradientBlobs = () => (
  <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
    ...
    />
    <div
      className="absolute -bottom-[16%] -right-[12%] w-[58vw] h-[58vw] max-w-[900px] max-h-[900px] rounded-full bg-green/[0.07] blur-[80px] animate-drift"
