  ...
  <section className="pt-20 sm:pt-24 pb-10 px-4 sm:px-8">
    <div className="w-full max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <motion.div variants={columnVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.4 }}>
          <motion.div variants={fadeItem}>
            <SectionKicker size="lg" className="mb-5">Our Work</SectionKicker>
          </motion.div>
          ...
          <motion.p variants={fadeItem} className="flex items-start gap-2 text-base leading-relaxed text-muted max-w-md mb-7">
            <ShieldCheck size={20} className="text-electric flex-shrink-0 mt-0.5" />
