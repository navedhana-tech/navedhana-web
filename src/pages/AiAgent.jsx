  ...
  <div className="bg-primary">
    <section className="pt-[168px] pb-6 px-4 sm:px-8 max-w-7xl mx-auto text-center">
      <motion.div {...fadeUp} className="max-w-2xl mx-auto">
        ...
        <span className="inline-block px-3 py-1.5 rounded-full bg-ink/[0.06] text-muted font-display text-[10.5px] font-bold tracking-wide">
          IN DEVELOPMENT
        </span>
      </motion.div>
    </section>
      ...
      <motion.div {...fadeUp} className="flex flex-col gap-7">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {CAPABILITIES.map((c) => (
              <span key={c} className="px-3.5 py-2 rounded-lg bg-ink/[0.045] border border-ink/15 text-[12.5px] font-display text-ink/80">
                {c}
              </span>
            ))}
          </div>
    ...
    <section className="py-16 mt-6 px-4 sm:px-8 text-center bg-surface">
