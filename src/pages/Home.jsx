            ...
            <section className="py-24 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600">Diverse solutions for modern needs</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {services.map((service, index) => (
                            ...
                            >
                                <div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} rounded-3xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300`}></div>

                                <div className={`relative bg-gradient-to-br ${service.bgGradient} rounded-3xl p-8 border border-white shadow-xl hover:shadow-2xl transition-all duration-300 h-full`}>
                                    <div className={`w-16 h-16 bg-gradient-to-br ${service.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-transform`}>
                                    ...
                                    <Link
                                        to={service.link}
                                        className={`inline-flex items-center font-semibold bg-gradient-to-r ${service.gradient} bg-clip-text text-transparent group-hover:gap-3 transition-all`}
                                    >
                                        Discover More
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-lg mb-1">{item.text}</h4>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        transition={{ delay: i * 0.1 }}
                                        className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/15 transition-colors"
                                    >
