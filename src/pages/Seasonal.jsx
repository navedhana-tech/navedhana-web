...
const Seasonal = () => {
 ...
 >
 <span className="px-4 py-2 bg-orange-100 text-orange-700 text-sm font-semibold tracking-wide uppercase">
 ...
 <motion.div
 className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-orange-100 border-2 border-orange-400 text-orange-700 font-bold text-base sm:text-lg shadow-lg"
 initial={{ opacity: 0, y: 20 }}
 animate={{ opacity: 1, y: 0 }}
 ...
 <motion.div
 key={idx}
 className={`absolute inset-0 bg-gradient-to-br ${card.color} shadow-2xl`}
 style={{
 ...
 >
 <div className={`absolute inset-0 bg-gradient-to-br ${product.gradient} blur-xl opacity-0 group-hover:opacity-20 transition-opacity`}></div>

 <div className={`relative bg-gradient-to-br ${product.bgGradient} p-6 md:p-8 border border-white shadow-xl hover:shadow-2xl transition-all h-full flex flex-col`}>
 <div className={`w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br ${product.gradient} flex items-center justify-center mb-6 shadow-lg transform group-hover:scale-110 group-hover:rotate-6 transition-transform`}>
 ...
 <span className={`inline-block px-4 py-2 ${product.statusColor} text-sm font-semibold`}>
 {product.status}
 </span>
 </div>
 </div>
 ...
 className="p-6"
 >
 <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
 ...
 className="flex-1 px-6 py-4 text-gray-900 focus:outline-none focus:ring-4 focus:ring-white/30 font-medium"
 />
 <button className="px-8 py-4 bg-gray-900 text-white font-bold hover:bg-gray-800 transition-all shadow-2xl transform hover:scale-105">
 Notify Me
 </button>
 </div>
 </div>
