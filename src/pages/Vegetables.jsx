...
const Vegetables = () => {
 ...
 >
 <span className="px-4 py-2 bg-green-100 text-green-700 text-sm font-semibold tracking-wide uppercase">
 Farm to Table
 </span>
 </motion.div>
 ...
 className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold text-base sm:text-lg shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 cursor-pointer"
 initial={{ opacity: 0, y: 20 }}
 animate={{ opacity: 1, y: 0 }}
 ...
 <motion.div
 className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-green-400 to-emerald-500 transform rotate-6"
 animate={{ rotate: [6, 8, 6] }}
 transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
 style={{ opacity: 0.2 }}
 />
 <motion.div
 className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-green-500 to-emerald-600 transform rotate-3"
 animate={{ rotate: [3, 5, 3] }}
 transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
 style={{ opacity: 0.3 }}
 />
 <div className="relative aspect-square shadow-2xl flex items-center justify-center overflow-hidden">
 {/* Background image */}
 <div
 ...
 >
 <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-emerald-600 blur-xl opacity-0 group-hover:opacity-20 transition-opacity"></div>
 <div className="relative p-8 bg-white border border-green-100 hover:border-green-300 shadow-lg hover:shadow-2xl transition-all">
 <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center mb-4 transform group-hover:scale-110 transition-transform">
 ...
 transition={{ delay: idx * 0.1 }}
 whileHover={{ scale: 1.05 }}
 className="group relative aspect-square overflow-hidden cursor-pointer shadow-lg hover:shadow-xl"
 >
 {/* Background Image */}
 <div
 ...
 <Link
 to="/contact"
 className="inline-block px-8 md:px-10 py-4 bg-white text-green-700 font-bold text-lg hover:bg-gray-100 transition-all shadow-2xl transform hover:scale-105"
 >
 Contact Us Now
 </Link>
 </div>
